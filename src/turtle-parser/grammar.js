...
export const PN_CHARS_U = new ebnf.Expression({
  // PN_CHARS_BASE | '_'
  name: 'PN_CHARS_U',
  terminal: true,
  lazy_expression: () => ebnf.or([PN_CHARS_BASE, ebnf.string('_')]),
});
export const PN_CHARS = new ebnf.Expression({
...
export const PN_LOCAL = new ebnf.Expression({
...
export const PN_PREFIX = new ebnf.Expression({
...
export const WS = new ebnf.Expression({
...
export const STRING_LITERAL_LONG_QUOTE = new ebnf.Expression({
  // '"""' (('"' | '""')? ([^"\] | ECHAR | UCHAR))* '"""'
...
export const STRING_LITERAL_LONG_SINGLE_QUOTE = new ebnf.Expression({
  // "'''" (("'" | "''")? ([^'\] | ECHAR | UCHAR))* "'''"
  name: 'STRING_LITERAL_LONG_SINGLE_QUOTE',
  terminal: true,
  lazy_expression: () => ebnf.sequence([ebnf.string("'''"), ebnf.zeroOrMore(ebnf.sequence([ebnf.optional(ebnf.or([ebnf.string("'"), ebnf.string("''")])), ebnf.or([ebnf.characterClass(/[^'\\]/), ECHAR, UCHAR])])), ebnf.string("'''")]),
});
export const STRING_LITERAL_SINGLE_QUOTE = new ebnf.Expression({
...
export const STRING_LITERAL_QUOTE = new ebnf.Expression({
...
export const EXPONENT = new ebnf.Expression({
  // [eE] [+-]? [0-9]+
  name: 'EXPONENT',
  terminal: true,
...
export const DOUBLE = new ebnf.Expression({
...
export const DECIMAL = new ebnf.Expression({
  // [+-]? [0-9]* '.' [0-9]+
  name: 'DECIMAL',
  terminal: true,
...
export const BLANK_NODE_LABEL = new ebnf.Expression({
...
export const PNAME_NS = new ebnf.Expression({
  // PN_PREFIX? ':'
  name: 'PNAME_NS',
  terminal: true,
  lazy_expression: () => ebnf.sequence([ebnf.optional(PN_PREFIX), ebnf.string(':')]),
});
export const PNAME_LN = new ebnf.Expression({
  // PNAME_NS PN_LOCAL
  name: 'PNAME_LN',
  terminal: true,
  lazy_expression: () => ebnf.sequence([PNAME_NS, PN_LOCAL]),
});
export const IRIREF = new ebnf.Expression({
...
export const BlankNode = new ebnf.Expression({
  // BLANK_NODE_LABEL | ANON
  name: 'BlankNode',
  terminal: false,
  lazy_expression: () => ebnf.or([BLANK_NODE_LABEL, ANON]),
});
export const PrefixedName = new ebnf.Expression({
  // PNAME_LN | PNAME_NS
  name: 'PrefixedName',
  terminal: false,
  lazy_expression: () => ebnf.or([PNAME_LN, PNAME_NS]),
});
export const iri = new ebnf.Expression({
  // IRIREF | PrefixedName
  name: 'iri',
  terminal: false,
  lazy_expression: () => ebnf.or([IRIREF, PrefixedName]),
});
export const String = new ebnf.Expression({
